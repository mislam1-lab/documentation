**Task: Create EC2 instances for Ansible controller and first target nodes, alsong with Controller, App-node and DB-node.**

Create a new folder named ansible in your techxxx-test-teraform alt text
<img width="854" height="586" alt="image" src="https://github.com/user-attachments/assets/ad51a049-744f-4fc2-9f7b-d351a5e2864f" />
